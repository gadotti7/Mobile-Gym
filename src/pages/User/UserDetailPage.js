...
import { watchWorkoutUser,deleteWorkout } from '../../actions';
					...
					renderItem={({ item }) => (
						<WorkoutCard
							workout={item}
								...
								onLongPress={async () => {await this.props.deleteWorkout(user, item)}} 
						/>
					)}
...
export default connect(mapStateToProps, { watchWorkoutUser, deleteWorkout }) (UserDetailPage);